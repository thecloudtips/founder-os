...
When two frameworks fit equally, prefer the one that matches the target audience segment. See `${CLAUDE_PLUGIN_ROOT}/skills/linkedin-writing/references/post-frameworks.md` for detailed templates, examples, and engagement tips for each framework.
