...
```
/linkedin:post "why I stopped using OKRs"
/linkedin:post "hiring your first engineer" --audience=founder --framework=story
/linkedin:post "AI tools for small teams" --length=long --emojis
/linkedin:post "cold email tips" --framework=listicle --audience=marketer --output=posts/cold-email.md
/linkedin:post "the future of remote work" --audience=cxo --framework=insight --length=long
```
