...
```
Error: Notion MCP is required for /prompt:list.
...
/prompt:list
/prompt:list sales
/prompt:list --search=email
/prompt:list --search=onboarding --limit=5
/prompt:list support --limit=10
/prompt:list writing --search=newsletter
```
