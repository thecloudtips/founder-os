...
Read the prompt-management skill at `${CLAUDE_PLUGIN_ROOT}/skills/prompt-management/SKILL.md` before proceeding.
...
```
Error: Notion MCP is required for /prompt:get.
...
```
/prompt:get "Client Intro Email"
/prompt:get "Weekly Status Update"
/prompt:get cold outreach
/prompt:get "Code Review Checklist"
/prompt:get competitor analysis
```
