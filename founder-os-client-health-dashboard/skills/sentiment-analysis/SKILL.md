...
For signal definitions, keyword lists, and detection criteria per signal type, see `${CLAUDE_PLUGIN_ROOT}/skills/sentiment-analysis/references/signal-patterns.md`.
...
For the full signal dictionary with detection criteria and thresholds, see `${CLAUDE_PLUGIN_ROOT}/skills/sentiment-analysis/references/signal-patterns.md`.
