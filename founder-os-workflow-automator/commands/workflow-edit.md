...
2. `${CLAUDE_PLUGIN_ROOT}/skills/workflow-scheduling/SKILL.md`
...
3. **Apply Modifications**:
   ...
   **--add-step**:
   a. Ask: "What command should this step run? (e.g., /inbox:triage)"
...
Use /workflow:run [name] --dry-run to preview changes
```
...
- Workflow not found: suggest /workflow:create
...
```
/workflow:edit morning-routine --add-step
/workflow:edit weekly-review --remove-step=old-report
/workflow:edit morning-routine --schedule="every weekday at 8:30am"
/workflow:edit client-onboarding --disable-schedule
/workflow:edit morning-routine
```
