...
- **No approved drafts found**: Report "No approved drafts found in Notion. Run /inbox:triage --team first, then approve drafts in Notion."
...
```
/inbox:drafts_approved    # Process all approved drafts from Notion to Gmail
```
