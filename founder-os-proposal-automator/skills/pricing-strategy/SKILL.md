...
- **`${CLAUDE_PLUGIN_ROOT}/skills/pricing-strategy/references/pricing-models.md`** — Complete examples of effort-based, value-based, and competitive pricing calculations with different project types
