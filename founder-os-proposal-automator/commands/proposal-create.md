...
Generate a complete professional proposal for a client with 7 structured sections and 3 pricing packages. Save the proposal and a SOW-compatible brief file for handoff to `/sow:from-brief`.
...
For detailed section examples, consult `${CLAUDE_PLUGIN_ROOT}/skills/proposal-writing/references/section-templates.md`.

For pricing calculation examples, consult `${CLAUDE_PLUGIN_ROOT}/skills/pricing-strategy/references/pricing-models.md`.
...
/proposal:create "NaluForge Inc" --output=./client-proposals/
/proposal:create --brief=briefs/project-alpha.md
/proposal:create "TechStart" --brief=scope-notes.txt --output=./proposals/
```
