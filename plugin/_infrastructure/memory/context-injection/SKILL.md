...
If the input is a user command string (e.g., `/client:load acme`), parse the arguments. If the input is structured (e.g., a meeting title, email subject), extract entities from those fields.
