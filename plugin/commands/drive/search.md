...
Read the drive-navigation skill at `${CLAUDE_PLUGIN_ROOT}/skills/drive/drive-navigation/SKILL.md` for search pipeline, query formulation, relevance scoring, folder traversal, and preview generation.
