...
> Run /founder-os:memory:show to review all active adaptations, or /founder-os:memory:forget "[key]" to revert this one.
```
...
> Run /founder-os:memory:show to review all active adaptations, or /founder-os:memory:forget "p01-acmecorp-action-required" to revert this one.
```
