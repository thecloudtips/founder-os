...
Follow the same drafting process as `/founder-os:linkedin:post` Phase 2:
...
Same as `/founder-os:linkedin:post`:
...
```
/founder-os:linkedin:from-doc blog-post.md
/founder-os:linkedin:from-doc ~/Documents/quarterly-report.pdf --framework=insight --audience=cxo
/founder-os:linkedin:from-doc meeting-notes.txt --length=short
/founder-os:linkedin:from-doc "Here is a long piece of text I want to turn into a LinkedIn post..."
/founder-os:linkedin:from-doc article.md --audience=technical --framework=howto --output=posts/dev-tips.md
```
