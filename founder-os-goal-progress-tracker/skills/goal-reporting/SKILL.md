...
Reference `${CLAUDE_PLUGIN_ROOT}/skills/goal-reporting/references/dashboard-table-format.md` for full column specifications, alignment rules, and edge case handling.
...
Reference `${CLAUDE_PLUGIN_ROOT}/skills/goal-reporting/references/gantt-generation.md` for complete Mermaid syntax examples, sanitization rules, and overflow handling strategies.
...
"No goals tracked yet. Use /goal:create to get started."
...
- `${CLAUDE_PLUGIN_ROOT}/skills/goal-reporting/references/dashboard-table-format.md` — Full column specifications, alignment rules, and formatting edge cases for the dashboard table.
- `${CLAUDE_PLUGIN_ROOT}/skills/goal-reporting/references/gantt-generation.md` — Complete Mermaid Gantt syntax reference, sanitization rules, overflow handling, and example chart source code.
