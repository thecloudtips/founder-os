...
2. Parent text contains decision keywords from `${CLAUDE_PLUGIN_ROOT}/skills/slack-analysis/references/decision-patterns.md`.
...
|----------|------|------------------|
| 1 | `decision` | Matches patterns from `${CLAUDE_PLUGIN_ROOT}/skills/slack-analysis/references/decision-patterns.md` + context signal validation (keyword + 2+ positive signals) |
...
`${CLAUDE_PLUGIN_ROOT}/skills/slack-analysis/references/decision-patterns.md`
