...
Detailed specifications for citation formatting, confidence scoring, no-answer templates, conflict reconciliation, and answer length guidelines. Referenced by `${CLAUDE_PLUGIN_ROOT}/skills/answer-synthesis/SKILL.md`.
