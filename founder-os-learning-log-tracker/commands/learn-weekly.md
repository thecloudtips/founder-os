...
1. `${CLAUDE_PLUGIN_ROOT}/skills/learning-synthesis/SKILL.md`
...
Use /learn:log to capture insights throughout the week.
...
Read `${CLAUDE_PLUGIN_ROOT}/skills/learning-synthesis/references/theme-detection-algorithm.md` for the full algorithm.
...
Read `${CLAUDE_PLUGIN_ROOT}/skills/learning-synthesis/references/streak-calculation.md` for the full algorithm.
...
/learn:weekly --output=both
/learn:weekly --output=./reports/week-10.md
```
