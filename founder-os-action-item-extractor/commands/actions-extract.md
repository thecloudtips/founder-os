...
- Halt with: "No text provided. Paste the content you want to extract action items from, or use `/actions:extract-file [path]` to process a file."
...
```
/actions:extract Meeting notes from standup: John will review the API spec by Friday. Sarah to update the deployment docs. AI: Schedule follow-up meeting for next week.

/actions:extract From: alice@example.com Subject: Q4 Planning Hi team, please review the attached budget by EOD Thursday. Bob, can you prepare the slide deck for Monday's presentation?

/actions:extract Next steps from project kickoff: 1. Draft project charter - Mike, by Jan 15 2. Set up development environment - Dev team, this week 3. Schedule stakeholder interviews - PM, ASAP
```
